...
const PrimaryMultipleSelectOptions = ["Option 1", "Option 2", "Option 3"];

/** Select options for `Single Select` */
const PrimarySingleSelectOptions = ["Choice 1", "Choice 2", "Choice 3"];
...
const PrimaryViews = ["Grid view", "Filter by View"];

/** View IDs for `Primary` */
const PrimaryViewIds = ["viwvPRDMaHyldUpmd", "viwHlcwGu4xthX1gf"];
