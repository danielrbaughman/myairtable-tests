...
class PrimaryModel extends AirtableModel {
    ...
    static fieldDescriptors = [
        ...
        { propertyName: "linkMultiple", fieldId: "fldFyFheQWczd8oux", fieldName: "Link (multiple)", isComputed: false, fieldType: "linkedRecords", linkedModelFromId: (id, config) => require("./secondary").SecondaryModel.fromId(id, config), get linkedModelClass() { return require("./secondary").SecondaryModel; } },
        { propertyName: "linkSingle", fieldId: "fld7F5onkDo6mkmbN", fieldName: "Link (single)", isComputed: false, fieldType: "linkedRecord", linkedModelFromId: (id, config) => require("./secondary").SecondaryModel.fromId(id, config), get linkedModelClass() { return require("./secondary").SecondaryModel; } },
