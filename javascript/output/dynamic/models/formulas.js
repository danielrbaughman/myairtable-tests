...
class FormulasModel extends AirtableModel {
    ...
    dateFormula(recalculate = false) {
        if (recalculate) this._fields["dateFormula"] = ((((((((((((((((((((((((((((((((((((((((((((("YEAR: " + F.S(F.D(this.firstDate).getUTCFullYear())) + ", MONTH: ") + F.S((F.D(this.firstDate).getUTCMonth() + 1))) + ", DAY: ") + F.S(F.D(this.firstDate).getUTCDate())) + ", HOUR: ") + F.S(F.D(this.secondDate).getUTCHours())) + ", MINUTE: ") + F.S(F.D(this.secondDate).getUTCMinutes())) + ", SECOND: ") + F.S(F.D(this.secondDate).getUTCSeconds())) + ", TODAY: ") + F.S(F.DATETIME_FORMAT(F.TODAY(), 'YYYY-MM-DD'))) + ", WORKDAY+5: ") + F.S(F.DATETIME_FORMAT(F.WORKDAY(this.firstDate, 5), 'YYYY-MM-DD'))) + ", WORKDAY_DIFF: ") + F.S(F.WORKDAY_DIFF(this.firstDate, this.secondDate))) + ", PARSE: ") + F.S(F.DATETIME_FORMAT(F.DATETIME_PARSE(F.DATESTR(this.firstDate)), 'YYYY-MM-DD'))) + ", FORMAT: ") + F.S(F.DATETIME_FORMAT(this.secondDate, 'YYYY-MM-DD HH:mm'))) + ", LOCALE: ") + F.S(F.DATETIME_FORMAT(F.SET_LOCALE(this.secondDate, 'en'), 'YYYY-MM-DD'))) + ", TIMEZONE: ") + F.S(F.DATETIME_FORMAT(F.SET_TIMEZONE(this.secondDate, 'America/New_York'), 'YYYY-MM-DD HH:mm'))) + ", DATESTR: ") + F.S(F.DATESTR(this.secondDate))) + ", TIMESTR: ") + F.S(F.TIMESTR(this.secondDate))) + ", TONOW: ") + F.S(F.TONOW(this.firstDate))) + ", FROMNOW: ") + F.S(F.FROMNOW(this.secondDate))) + ", DATEADD+2d: ") + F.S(F.DATETIME_FORMAT(F.DATEADD(this.firstDate, 2, 'days'), 'YYYY-MM-DD'))) + ", WEEKNUM: ") + F.S(F.WEEKNUM(this.firstDate, 'Monday'))) + ", DIFF days: ") + F.S(F.DATETIME_DIFF(this.firstDate, this.secondDate, 'days'))) + ", IS_BEFORE: ") + F.S((F.IS_BEFORE(this.firstDate, this.secondDate) ? 'Yes' : 'No'))) + ", IS_SAME day: ") + F.S((F.IS_SAME(this.firstDate, this.secondDate, 'day') ? 'Yes' : 'No'))) + ", IS_AFTER: ") + F.S((F.IS_AFTER(this.thirdDate, this.secondDate) ? 'Yes' : 'No')));
