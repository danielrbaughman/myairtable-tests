...
class FormulasModel(Model):
    ...
    def date_formula(self, recalculate: bool = False) -> str | None:
        if recalculate:
            self._fields["fldY7kjaklLeoSgGd"] = ((((((((((((((((((((((((((((((((((((((((((((("YEAR: " + F.S(F.D(self.first_date).year)) + ", MONTH: ") + F.S(F.D(self.first_date).month)) + ", DAY: ") + F.S(F.D(self.first_date).day)) + ", HOUR: ") + F.S(F.D(self.second_date).hour)) + ", MINUTE: ") + F.S(F.D(self.second_date).minute)) + ", SECOND: ") + F.S(F.D(self.second_date).second)) + ", TODAY: ") + F.S(F.DATETIME_FORMAT(F.TODAY(), 'YYYY-MM-DD'))) + ", WORKDAY+5: ") + F.S(F.DATETIME_FORMAT(F.WORKDAY(self.first_date, 5), 'YYYY-MM-DD'))) + ", WORKDAY_DIFF: ") + F.S(F.WORKDAY_DIFF(self.first_date, self.second_date))) + ", PARSE: ") + F.S(F.DATETIME_FORMAT(F.D(F.DATESTR(self.first_date)), 'YYYY-MM-DD'))) + ", FORMAT: ") + F.S(F.DATETIME_FORMAT(self.second_date, 'YYYY-MM-DD HH:mm'))) + ", LOCALE: ") + F.S(F.DATETIME_FORMAT(self.second_date, 'YYYY-MM-DD'))) + ", TIMEZONE: ") + F.S(F.DATETIME_FORMAT(F.SET_TIMEZONE(self.second_date, 'America/New_York'), 'YYYY-MM-DD HH:mm'))) + ", DATESTR: ") + F.S(F.DATESTR(self.second_date))) + ", TIMESTR: ") + F.S(F.TIMESTR(self.second_date))) + ", TONOW: ") + F.S(F.TONOW(self.first_date))) + ", FROMNOW: ") + F.S(F.FROMNOW(self.second_date))) + ", DATEADD+2d: ") + F.S(F.DATETIME_FORMAT(F.DATEADD(self.first_date, 2, 'days'), 'YYYY-MM-DD'))) + ", WEEKNUM: ") + F.S(F.WEEKNUM(self.first_date, 'Monday'))) + ", DIFF days: ") + F.S(F.DATETIME_DIFF(self.first_date, self.second_date, 'days'))) + ", IS_BEFORE: ") + F.S(('Yes' if F.IS_BEFORE(self.first_date, self.second_date) else 'No'))) + ", IS_SAME day: ") + F.S(('Yes' if F.IS_SAME(self.first_date, self.second_date, 'day') else 'No'))) + ", IS_AFTER: ") + F.S(('Yes' if F.IS_AFTER(self.third_date, self.second_date) else 'No')))
