...
export class FormulasModel extends AirtableModel<FormulasFieldSet, IFormulas, FormulasField> {
    ...
    public get textFormula(): string | undefined {
        if (this.evaluateFormulasAtRuntime) this._fields["textFormula"] = ["LEN: ", F.S(this.firstText).length, "; ", "MID: ", F.MID(this.firstText, 2, 3), "; ", "LEFT: ", F.LEFT(this.secondText, 2), "; ", "RIGHT: ", F.RIGHT(this.secondText, 2), "; ", "FIND: ", F.FIND("e", this.firstText), "; ", "SEARCH: ", F.SEARCH("e", this.firstText), "; ", "REPLACE: ", F.REPLACE(this.firstText, 2, 2, "XX"), "; ", "REPT: ", F.S(this.firstText).repeat(2), "; ", "LOWER: ", F.S(this.secondText).toLowerCase(), "; ", "UPPER: ", F.S(this.secondText).toUpperCase(), "; ", "TRIM: ", (("   " + F.S(this.firstText)) + "   ").trim(), "; ", "SUBSTITUTE: ", F.SUBSTITUTE(this.firstText, "e", "@"), "; ", "CONCATENATE: ", [this.firstText, "-", this.secondText, "-", this.thirdText].map((_x) => F.S(_x)).join(""), "; ", "T: ", F.T(this.firstNumber), "; ", "REGEX_EXTRACT: ", (F.S(this.firstText).match(new RegExp("[aeiou]"))?.[0] ?? null), "; ", "REGEX_MATCH: ", (new RegExp("^.e").test(F.S(this.firstText)) ? "1" : "0"), "; ", "REGEX_REPLACE: ", F.S(this.firstText).replace(new RegExp("[aeiou]", "g"), "*"), "; ", "ENCODE_URL_COMPONENT: ", encodeURIComponent(F.S(this.firstText))].map((_x) => F.S(_x)).join("");
