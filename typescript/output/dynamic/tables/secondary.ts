...
export class SecondaryTable extends AirtableTable<SecondaryFieldSet, SecondaryModel, SecondaryView, SecondaryField> {
    ...
    constructor(baseId: string, options: AirtableOptions) {
        super(baseId, "tblPPScS3XMuFkDYN", SecondaryViewNameIdMapping, SecondaryFieldNameIdMapping, SecondaryFieldIdNameMapping, SecondaryWritableFieldIds, (record) => SecondaryModel.fromRecord(record, this), options);
    }
}
