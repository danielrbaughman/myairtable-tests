...
export class PrimaryTable extends AirtableTable<PrimaryFieldSet, PrimaryModel, PrimaryView, PrimaryField> {
    ...
    constructor(baseId: string, options: AirtableOptions) {
        super(baseId, "tblmb3iqgpNS1ysV2", PrimaryViewNameIdMapping, PrimaryFieldNameIdMapping, PrimaryFieldIdNameMapping, PrimaryWritableFieldIds, (record) => PrimaryModel.fromRecord(record, this), options);
    }
}
